            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ marginBottom: 80 }}>
                ...
                >
                    ...
                    <View style={{ backgroundColor: 'white', padding: 30, margin: 30, marginBottom: 10 }}>
                        <Text style={{ fontWeight: 700, fontSize: 17, marginBottom: 30, textAlign: 'center' }}>Location</Text>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                        <TouchableOpacity onPress={() => handleOptionChange('Option 1')}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <RadioButton.Android
                                    value="Option 1"
                                    status={selectedOption === 'Option 1' ? 'checked' : 'unchecked'}
                        ...
                        <TouchableOpacity onPress={() => handleOptionChange('Option 2')}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <RadioButton.Android
                                    value="Option 2"
                                    status={selectedOption === 'Option 2' ? 'checked' : 'unchecked'}
                        ...
                        <TouchableOpacity onPress={() => handleOptionChange('Option 3')}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <RadioButton.Android
                                    value="Option 3"
                                    status={selectedOption === 'Option 3' ? 'checked' : 'unchecked'}
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 30 }}>
                        <TouchableOpacity onPress={() => navigation.goBack()}>
                            <Text style={{ padding: 10, backgroundColor: 'white', color: 'black', borderRadius: 5, marginRight: 10, width: 80, textAlign: 'center' }}>
                                Cancel
                            </Text>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={handleSave}>
                            <Text style={{ padding: 10, backgroundColor: 'white', color: 'black', borderRadius: 5, width: 80, textAlign: 'center' }}>
                                Save
                            </Text>
                        </TouchableOpacity>
                    </View>
